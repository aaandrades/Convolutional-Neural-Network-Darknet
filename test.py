...
ap.add_argument('-cl', '--classes', 
                help = 'path to text file containing class names',default='objects.names')
args = ap.parse_args()
...
# Draw a rectangle surrounding the object and its class name 
